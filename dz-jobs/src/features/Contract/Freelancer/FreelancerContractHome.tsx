...
import { useGetAllJobsQuery, useGetContractsCountByFreelancerQuery } from "../../../app/services/DZJobsApi";
import { FreelancerContractTabs } from "./FreelancerContractGrids/FreelancerContractTabs";

export const FreelancerContractHome = () => {
  const user = useSelector((state: RootState) => state.auth);
  const { data: freelancerCounts } = useGetContractsCountByFreelancerQuery({ freelancerId: user.userId });
