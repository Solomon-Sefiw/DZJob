...
import { JobDto, useGetAllJobByStatusQuery } from "../../../app/services/DZJobsApi";
import { Pagination } from "../../../components/Pagination";
import { JobDetailsDialog } from "../../Job/JobDetailsDialog";
import { ApplayforJobDialog } from "../../JobApplication/ApplayforJobDialog";
import { JobStatus } from "../../../app/services/enums";
...
export const ArchivedJobs = () => {
  ...
  const { data: items, isLoading: isListLoading,refetch } = useGetAllJobByStatusQuery({
